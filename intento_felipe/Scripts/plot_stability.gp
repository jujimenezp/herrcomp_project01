...
set yrange [0:*]
set ylabel 'Slope'
plot 'Data/data_stability.txt' u 1:2 ls 1 t 'Slope'


set title 'Deviation vs Time'
set yrange [0:*]
set ylabel 'Deviation'
plot 'Data/data_stability.txt' u 1:3 ls 1 t 'Deviation'

set title 'Counter vs Time'
set yrange [0:*]
set ylabel 'Counter'
plot 'Data/data_stability.txt' u 1:4 ls 1 t 'Counter slope', 'Data/data_stability.txt' u 1:5 ls 2 t 'Counter deviation', 'Data/data_stability.txt' u 1:6 ls 3 t 'Counter'
